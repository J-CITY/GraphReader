...
Для тестирования разработанного приложения был взят OMS файл Магаданской области.
Время работы приложения: 25 секунд.
Размер файла: 7 MB.
Так же был разработан генератор тестов. С помощю него были сгенерированны OSM файлы.
с количеством узлов от 5 до 10000.
@d method GenTest @{
